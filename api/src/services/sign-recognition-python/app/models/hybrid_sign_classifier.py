...
class HybridSignClassifier:
    ...
    def predict(self, sequence_array: np.ndarray):
        ...
        # Validar shape de del input TFlite
        ...
        try:
            ...
            # Proceso de inferencia TFlite
            # input_data = seq_scaled.astype(self.input_details[0]["dtype"])
            ...
            # Obtener resultados
            #preds = self.model.get_tensor(self.output_details[0]["index"])
            # Prediccion
